...
namespace CodeMonkey.Utils {
    ...
    public class World_Sprite {
        ...
        public static World_Sprite CreateDebugButton(Transform parent, Vector3 localPosition, string text, System.Action ClickFunc, float characterSize = 0.03f, int fontSize = 30, float paddingX = 5, float paddingY = 5) {
            GameObject gameObject = new GameObject("DebugButton");
            gameObject.transform.parent = parent;
            gameObject.transform.localPosition = localPosition;
            TextMesh textMesh = UtilsClass.CreateWorldText(text, gameObject.transform, Vector3.zero, characterSize, fontSize, Color.white, TextAnchor.MiddleCenter, TextAlignment.Center, 20000);
