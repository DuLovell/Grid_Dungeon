...
namespace CodeMonkey {
    ...
    public static class CMDebug {
        ...
        public static World_Sprite Button(Transform parent, Vector3 localPosition, string text, System.Action ClickFunc, float characterSize = 0.03f, int fontSize = 30, float paddingX = 5, float paddingY = 5) {
            return World_Sprite.CreateDebugButton(parent, localPosition, text, ClickFunc, characterSize, fontSize, paddingX, paddingY);
        }
        ...
        public static void Text(string text, Vector3 localPosition = default(Vector3), Transform parent = null, float characterSize = 0.03f, int fontSize = 40, Color? color = null, TextAnchor textAnchor = TextAnchor.UpperLeft, TextAlignment textAlignment = TextAlignment.Left, int sortingOrder = UtilsClass.sortingOrderDefault) {
            UtilsClass.CreateWorldText(text, parent, localPosition, characterSize, fontSize, color, textAnchor, textAlignment, sortingOrder);
        }
        ...
        public static FunctionUpdater TextUpdater(Func<string> GetTextFunc, Vector3 localPosition, Transform parent = null, float characterSize = 0.03f, int fontSize = 40, Color? color = null, TextAnchor textAnchor = TextAnchor.UpperLeft, TextAlignment textAlignment = TextAlignment.Left, int sortingOrder = UtilsClass.sortingOrderDefault) {
            return UtilsClass.CreateWorldTextUpdater(GetTextFunc, localPosition, parent, characterSize, fontSize, color, textAnchor, textAlignment, sortingOrder);
        }
